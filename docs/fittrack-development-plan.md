...
- 媒体策略：58 个系统动作各使用 1 张经过动作要领与器械结构审核的 1200×800 JPEG；当前 51 张项目制作图按 CC0 1.0 提供，7 张 Free Exercise DB 实拍按 Unlicense 分发。国内视频平台截图、MuscleDB 授权不明图片和旧图片目录不进入 APK
...
- 每项动作统一展示 1 张已审核的本地动作图。29 项清单动作采用用户原文的发力要点、注意事项与常见错误；清单外旧动作只替换 MuscleDB 能明确提供的文字字段，保留既有训练参数。当前 51 张项目制作图按 CC0 1.0 提供，7 张 Free Exercise DB 实拍按 Unlicense 分发，动作详情显示标题、来源和许可证。
