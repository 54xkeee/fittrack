...
会把这些文件与实际构建所用 Qt 6.11.1 SBOM、Android NDK NOTICE、组件通知和媒体
...
- `LGPL-3.0-only.txt`、`GPL-3.0-only.txt`：Qt 6.11.1 开源分发路径。
...
Qt/SPDX 正文来自本项目构建所用 Qt 6.11.1 安装的许可证目录；Creative Commons
